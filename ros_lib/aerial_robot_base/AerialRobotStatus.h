#ifndef _ROS_aerial_robot_base_AerialRobotStatus_h
#define _ROS_aerial_robot_base_AerialRobotStatus_h
...
namespace aerial_robot_base
{
  ...
  class AerialRobotStatus : public ros::Msg
  {
    ...
    const char * getType(){ return "aerial_robot_base/AerialRobotStatus"; };
